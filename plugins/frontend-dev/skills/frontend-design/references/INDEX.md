...
照某个知名产品的风格来做时，在下表挑一个品牌，读 `design-md/<目录>/DESIGN.md`，把里面的配色、字体、组件 token 当设计依据。

共 73 个品牌。来源与许可见 `ATTRIBUTION.md`。
...
- **Slack** — `slack` — Workplace messaging. Deep aubergine primary, cream-lavender hero gradients, pill CTAs
